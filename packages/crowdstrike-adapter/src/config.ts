...
export const DEFAULT_CONFIG: UserConfig = {
  fetch: {
    ...
    exclude: [
      // Both of these types show device information, which includes dynamic fields (like local IP and last seen) and
      // they seem to be more "data" than "configuration", so exclude them by default.
      { type: 'Device' },
      { type: 'FirewallMember' },
    ],
    hideTypes: true,
