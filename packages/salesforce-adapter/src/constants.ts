...
export const GEN_AI_PROMPT_TEMPLATE_METADATA_TYPE = 'GenAiPromptTemplate'
export const GEN_AI_PROMPT_TEMPLATE_VERSION_METADATA_TYPE = 'GenAiPromptTemplateVersion'
